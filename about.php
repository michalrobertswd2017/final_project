 <? include("header.php"); ?>
    ...
    <body>
        <main>
            <h2 class="about_title">About Play Therapy</h2>
...
Play Therapy offers children an experience of acceptance, non-judgement, encouragement and freedom. It supports a child's ability to sort out their struggles through play, helping them grow towards healing, health and resilience.
                ...
                <br>
Child-centred play therapy respects the individual needs and personality of each child, allowing them to pave their own unique journey towards psychological well being and growth in the confines of a safe, therapeutic space. This means that the ideal amount of sessions is the amount that it takes for a child, and their family, to experience a shift.

   <p>
        <br>
Part of the healing journey is the empowerment for the child of making choices. If I feel a directive activity is appropriate , I will invite the child to try, but my core stance is allowing the child to direct their own pace.
                    </p>
                </div>
        </main>
        <script src="...."></script>
